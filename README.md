A basic example for using the Bitcoin|Computer. It's a smart contract written in Javascript and deployed using node.js. The smart contract is a vanilla Javascript program:
